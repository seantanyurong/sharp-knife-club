export const googleReviews = [
  ...
  },
  {
    ...
    rating: 5,
    comment:
      'If you’re looking for a place to sharpen those knives of yours, look no further than this! Excellent and top notch service. He will pickup and deliver back to you with no worries. Love the quality of the finishing of my kitchen knives. Thank you very much Sean.',
    image: true,
  },
  {
    src: 'Doreen-Leong',
  ...
  },
  {
    ...
    rating: 5,
    comment:
      'I am so pleased with their services. When I contacted them via WhatsApp, they replied promptly. Payment was easy. The door-to-door service was excellent. Instructions was so clear as to how I should pack my knives and how the knives will be collected. I am now able to cut through my fruits in one stroke.',
    image: false,
  },
];
